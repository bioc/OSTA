...
The book contains discussion chapters, analysis chapters, and workflow chapters. The analysis and workflow chapters describe individual analysis steps as well as extended workflows, each with examples including R code and datasets. In some examples, R code is also integrated with Python tools.
...
- **Appendices:** contributions, acknowledgments, related resources, and session information
...
The source code of the book is available from [GitHub](https://github.com/lmweber/OSTA) and the [Bioconductor Git repository](https://code.bioconductor.org/).
