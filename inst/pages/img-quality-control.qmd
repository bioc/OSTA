...
more intricate quality control metrics using the `SpaceTrooper` package.
:::
...
Moreover, they vary from a few hundred (e.g., 313 in the first Xenium panel)
...
that can be used to check for nonspecific RNA captures.

Finally, imaging-based platforms include, in addition to transcript data,
