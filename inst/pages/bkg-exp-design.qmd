# Experimental design {#sec-bkg-exp-design}
...
as well as strategies to guide panel and region of interest (ROI) selection.
...
- **RNA** is more sensitive than DNA, yet still highly durable.
High-quality whole-transcriptome data has been recovered from FFPE blocks
...
- **Proteins** are highly stable within the paraffin matrix of an intact block
...
There is a critical distinction between **blocks** and **cut slides**:
...
(nuclear quality assessment). Beyond this, these stains serve several
...
sample size and sequencing depth needed to reliably detect changes in expression.
...
Dating back to the 90s, well before ST came to the field, TMAs have become
...
to molecular crowding) and increase spatial bleeding (see also @sec-img-segmentation).
:::

### Selecting microdissection sites
...
[The `r BiocStyle::Biocpkg("GeomxTools")` R/Bioconductor package provides functionality for analyzing (protein and transcriptomics) GeoMx data, including quality control, normalization, differential testing, and visualization.]{.aside}
