...
- The R package [STcompare](https://jef.works/STcompare/) [@Clifton2025-STcompare] provides a statistical framework for comparative ST analysis by identifying genes with differential spatial expression patterns between conditions.

- The Python package `r BiocStyle::Githubpkg("xiaojierzi/CODA")` [@Tan2026-CODA] provides methods for cross-sample alignment of ST data and identification of spatially informative genes across tissues and conditions.
