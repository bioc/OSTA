...
The processing steps carried out here -- namely, normalization, dimensionality reduction, and clustering -- lay the foundation for a variety of downstream analysis tasks that will be covered in the next chapters.
Here, we run standard non-spatial and spatially-aware approaches as a compact imaging-based processing demo. For a more comprehensive overview of methodology and tools, see @sec-ind-normalization on normalization, @sec-ind-dimensionality-reduction on dimensionality reduction, @sec-ind-clustering on clustering, and @sec-ind-feature-selection-testing on feature selection and testing.
