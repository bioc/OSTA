...
One option in point pattern analysis is to analyze the correlation of marks. For example, clustering or spacing of cells can be determined relative to a completely spatially random (CSR) process.
