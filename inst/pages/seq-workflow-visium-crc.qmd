...
```{r plt-auc-hm, echo=-1, fig.width=4, fig.height=4}
#| layout-ncol: 2
#| code-fold: true
par(mar=c(0,0,0,0))
...
```{r plt-cor, echo=-1, fig.width=4, fig.height=4}
#| code-fold: true
#| fig-align: center
par(mar=c(0,0,0,0))
pheatmap(cm, 
...
- @sec-seq-quality-control on quality control, 
- @sec-seq-deconvolution on deconvolution, 
