...
This chapter is intended as a compact sequencing-based processing demo. For more comprehensive and platform-independent discussion, see @sec-ind-normalization, @sec-ind-feature-selection-testing, @sec-ind-dimensionality-reduction, and @sec-ind-clustering.
...
After completing the intermediate processing steps above, we next demonstrate some short examples of downstream analysis steps. These examples are included to show how processed objects feed into later analyses; the more detailed method discussion is deferred to the platform-independent chapters linked below.
